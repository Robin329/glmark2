...
function create_APK() {
    ...
    $JAVA_HOME/bin/javac -d ./obj -source 1.8 -target 1.8 -bootclasspath $JAVA_HOME/jre/lib/rt.jar -classpath $ANDROID_JAR:obj -sourcepath src src/org/linaro/glmark2/*.java
